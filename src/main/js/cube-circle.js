...
(function (cube, undefined) {
    ...
    cube.circle = function (x, y, radius, vx, vy) {
        return new cube.Circle(x, y, radius, vx, vy);
    };
     ...
     */
    cube.Circle = function (x, y, radius, vx, vy, density) {
        cube.Vector.call(this, x, y);
        this._radius = radius;
        this._velocity = cube.vector(vx || 0, vy || 0);
        this._box = cube.box(x - radius, y - radius, radius * 2, radius * 2);
        this._density = density || 1;
        this._area = undefined;
        this._volume = undefined;
        this._mass = undefined;
    };
    cube.Circle.prototype = Object.create(cube.Vector.prototype);
    cube.Circle.constructor = cube.Vector;

    cube.Circle.prototype = {
        set x(value) {
            if (this._x !== value) {
                this._x = value;
    ...
    cube.Circle.prototype.clone = function () {
        var circle = cube.circle(this.x, this.y, this.radius, this.velocity.x, this.velocity.y, this.density);
    ...
    cube.Circle.prototype.scale = function (scalar, clone) {
